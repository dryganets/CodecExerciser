...
import com.snap.codec.exerciser.player.SurfaceManager;
 ...
 */
public class SurfaceShuffleActivity extends Activity implements OnItemSelectedListener,
    ...
    private SurfaceManager mSurfaceManager = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceManager = new SurfaceManager(this, 3, mSurfaceListener,
                (SurfaceView) findViewById(R.id.playMovie_surface),
                (SurfaceView) findViewById(R.id.playMovie_surface2),
                (SurfaceView) findViewById(R.id.playMovie_surface3),
                (SurfaceView) findViewById(R.id.playMovie_surface4),
                (SurfaceView) findViewById(R.id.playMovie_surface5),
                (SurfaceView) findViewById(R.id.playMovie_surface6)
        );
    ...
    public void clickPlayStop(@SuppressWarnings("unused") View unused) {
        if (mShowStopLabel) {
            ...
            SurfaceHolder holder = mSurfaceManager.getCurrentHolder();
            ...
            try {
                ...
                Log.e(TAG, "Unable to play movie", ex);
                surface.release();
                return;
            }
    ...
    /**
     * onClick handler for "shuffleSurface" button.
     */
    public void clickShuffleSurface(View view) {
        if (mPlayer != null) {
            mSurfaceManager.shuffle();
            mPlayer.setOutputSurface(mSurfaceManager.getCurrentHolder().getSurface());
        }
    }
